...
# Paths to your files and folders
train_csv = r'C:/Users/Mabelle/Desktop/TrafficSignProject/Train.csv'  # Path to Train.csv
test_csv = r'C:/Users/Mabelle/Desktop/TrafficSignProject/Test.csv'    # Path to Test.csv
images_train_folder = r'C:/Users/Mabelle/Desktop/TrafficSignProject/images/train'
images_test_folder = r'C:/Users/Mabelle/Desktop/TrafficSignProject/images/test'
labels_train_folder = r'C:/Users/Mabelle/Desktop/TrafficSignProject/labels/train'
labels_test_folder = r'C:/Users/Mabelle/Desktop/TrafficSignProject/labels/test'

# Ensure the labels folders exist
...
def process_annotations(csv_file, images_folder, labels_folder):
    ...
    for _, row in df.iterrows():
        ...
        image_name = row['Path'].split('/')[-1]  # Extract filename from the Path column
...
# Process training and testing annotations
